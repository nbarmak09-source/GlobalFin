      ...
      <div className="rounded-xl border border-border bg-card p-6 space-y-4 shadow-2xl shadow-black/30">
          ...
          {showResendVerification && (
            <div className="space-y-2">
              <button
                ...
                className="w-full rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-card-hover transition-colors duration-200 disabled:opacity-50 min-h-[44px] cursor-pointer"
              >
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="flex items-center justify-center rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-foreground hover:bg-card-hover transition-colors duration-200 min-h-[44px] cursor-pointer"
          >
